				...
				<div class="col-lg-3 col-md-6 col-sm-12 mb-30">
					<div class="bg-white pd-30 box-shadow border-radius-5 height-100-p">
						<div class="progress-box text-center">
							...
							<h5 class="text-blue padding-top-10 weight-500">Recettes</h5>
							<span class="font-14">66% d'objectif atteint <i class="fa fa-line-chart"></i></span>
						</div>
					</div>
				</div>
				<div class="col-lg-3 col-md-6 col-sm-12 mb-30">
					<div class="bg-white pd-30 box-shadow border-radius-5 height-100-p">
						<div class="progress-box text-center">
							...
							<h5 class="text-light-green padding-top-10 weight-500">Commande</h5>
							<span class="font-14">75% atteint <i class="fa fa-line-chart"></i></span>
						</div>
					</div>
				</div>
				<div class="col-lg-3 col-md-6 col-sm-12 mb-30">
					<div class="bg-white pd-30 box-shadow border-radius-5 height-100-p">
						<div class="progress-box text-center">
							...
							<h5 class="text-light-orange padding-top-10 weight-500">Nouveaux clients</h5>
							<span class="font-14">90% atteint <i class="fa fa-line-chart"></i></span>
						</div>
					</div>
				</div>
				<div class="col-lg-3 col-md-6 col-sm-12 mb-30">
					<div class="bg-white pd-30 box-shadow border-radius-5 height-100-p">
						<div class="progress-box text-center">
							...
							<h5 class="text-light-purple padding-top-10 weight-500">En ligne</h5>
							<span class="font-14">35% Connectés actuellement <i class="fa fa-line-chart"></i></span>
						</div>
					</div>
				</div>
			</div>
			<div class="bg-white pd-30 box-shadow border-radius-5 mb-30 xs-pd-20-10">
				<div class="row clearfix">
					<div class="col-lg-3 col-md-6 col-sm-12">
						<h4 class="mb-30">Visites par navigateur/pays</h4>
