				...
				<ul id="accordion-menu">
					<li class="dropdown">
						<a href="javascript:;" class="dropdown-toggle">
							<span class="fa fa-home"></span><span class="mtext">Accueil</span>
						</a>
						<ul class="submenu">
						...
						<ul class="submenu">
							...
							<li class="dropdown">
								...
								<ul class="submenu child">
									<li><a href="javascript:;">Attributs</a></li>
					...
					<li class="dropdown">
						<a href="javascript:;" class="dropdown-toggle">
							<span class="fa fa-list"></span><span class="mtext">Design</span>
						</a>
						<ul class="submenu">
					...
					<li class="dropdown">
						...
						<ul class="submenu">
							...
							<li class="dropdown">
								<a href="javascript:;" class="dropdown-toggle">
									<span class="fa fa-file"></span><span class="mtext">Cheques cadeaux</span>
								</a>
								<ul class="submenu child">
									<li><a href="javascript:;">Codes</a></li>
									<li><a href="javascript:;">Campagnes</a></li>
								</ul>
							</li>
						</ul>
					</li>
					...
					<li class="dropdown">
						<a href="javascript:;" class="dropdown-toggle">
							<span class="fa fa-list"></span><span class="mtext">Clients</span>
						</a>
						<ul class="submenu">
							<li><a href="#">Clients</a></li>
							<li><a href="#">Groupes clients</a></li>
							<li><a href="#">Validations comptes</a></li>
						</ul>
					</li>

					<li class="dropdown">
						<a href="javascript:;" class="dropdown-toggle">
							<span class="fa fa-list"></span><span class="mtext">Marketing</span>
						</a>
						<ul class="submenu">
							<li><a href="#">Marketing</a></li>
							<li><a href="#">Codes promotionnels</a></li>
					...
					<li class="dropdown">
						<a href="javascript:;" class="dropdown-toggle">
							<span class="fa fa-list"></span><span class="mtext">Système</span>
						</a>
						<ul class="submenu">
							<li><a href="#">Boutiques</a></li>
							<li class="dropdown">
								<a href="javascript:;" class="dropdown-toggle">
									<span class="fa fa-list"></span><span class="mtext">Données diverses</span>
								</a>
								<ul class="submenu">
									<li><a href="#">Langues</a></li>
									<li><a href="#">Monnaies</a></li>
									<li><a href="#">Statuts stocks</a></li>
									<li><a href="#">Statuts commandes</a></li>
									<li><a href="#">Pays</a></li>
									<li><a href="#">Zones de livraison</a></li>
									<li><a href="#">Unités de taille</a></li>
									<li><a href="#">Unités de poids</a></li>
									<li class="dropdown">
										<a href="javascript:;" class="dropdown-toggle">
											<span class="fa fa-list"></span><span class="mtext">Retours</span>
										</a>
										<ul class="submenu">
											<li><a href="#">Statuts retour</a></li>
											<li><a href="#">Actions retour</a></li>
											<li><a href="#">Raisons retour</a></li>
							...
							<li class="dropdown">
								<a href="javascript:;" class="dropdown-toggle">
									<span class="fa fa-list"></span><span class="mtext">Maintenance</span>
								</a>
								<ul class="submenu">
									<li><a href="#">Sauvegarde données</a></li>
								</ul>
							</li>
						</ul>
					</li>
					...
					<li class="dropdown">
						<a href="javascript:;" class="dropdown-toggle">
							<span class="fa fa-list"></span><span class="mtext">Reporting</span>
						</a>
						<ul class="submenu">
							<li><a href="#">Reporting</a></li>
							<li><a href="#">Utilisateurs connectés</a></li>
